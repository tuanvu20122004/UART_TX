...
--               e:/Xlinx/FPGA_Prj/KV260_TX/KV260_TX.gen/sources_1/bd/design_1/ip/design_1_top_0_0/design_1_top_0_0_sim_netlist.vhdl
...
entity design_1_top_0_0_uart_tx is
  port (
  ...
  attribute ORIG_REF_NAME of design_1_top_0_0_uart_tx : entity is "uart_tx";
end design_1_top_0_0_uart_tx;

architecture STRUCTURE of design_1_top_0_0_uart_tx is
  ...
  attribute SOFT_HLUTNM of \bit_idx[2]_i_2\ : label is "soft_lutpair5";
  ...
  attribute SOFT_HLUTNM of \idx[2]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \tx_data[6]_i_1\ : label is "soft_lutpair8";
...
\tx_data[6]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
architecture STRUCTURE of design_1_top_0_0_top is
  ...
  attribute FSM_ENCODED_STATES : string;
  attribute FSM_ENCODED_STATES of \FSM_onehot_state_reg[0]\ : label is "S_PULSE:100,S_LOAD:010,S_WAIT:001";
  attribute FSM_ENCODED_STATES of \FSM_onehot_state_reg[1]\ : label is "S_PULSE:100,S_LOAD:010,S_WAIT:001";
  attribute FSM_ENCODED_STATES of \FSM_onehot_state_reg[2]\ : label is "S_PULSE:100,S_LOAD:010,S_WAIT:001";
  ...
  attribute SOFT_HLUTNM of \gap_cnt[10]_i_1\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \gap_cnt[11]_i_1\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \gap_cnt[12]_i_1\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \gap_cnt[13]_i_1\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \gap_cnt[14]_i_1\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \gap_cnt[15]_i_1\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \gap_cnt[16]_i_1\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \gap_cnt[17]_i_1\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \gap_cnt[18]_i_1\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \gap_cnt[19]_i_1\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \gap_cnt[1]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \gap_cnt[20]_i_1\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \gap_cnt[21]_i_1\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \gap_cnt[22]_i_1\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \gap_cnt[23]_i_1\ : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of \gap_cnt[24]_i_1\ : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of \gap_cnt[2]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \gap_cnt[3]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \gap_cnt[4]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \gap_cnt[5]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \gap_cnt[6]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \gap_cnt[7]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \gap_cnt[8]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \gap_cnt[9]_i_1\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \idx[0]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \idx[1]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \idx[2]_i_2\ : label is "soft_lutpair9";
  ...
  attribute SOFT_HLUTNM of \tx_data[0]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \tx_data[2]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \tx_data[3]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \tx_data[6]_i_2\ : label is "soft_lutpair12";
begin
...
\tx_data[6]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"1F"
    )
        port map (
...
u_uart_tx: entity work.design_1_top_0_0_uart_tx
     port map (
      E(0) => u_uart_tx_n_2,
      \FSM_onehot_state_reg[0]\(0) => idx,
      \FSM_onehot_state_reg[0]_0\ => \FSM_onehot_state[2]_i_2_n_0\,
      \FSM_onehot_state_reg[2]\(0) => u_uart_tx_n_3,
...
entity design_1_top_0_0 is
  ...
  attribute X_CORE_INFO of design_1_top_0_0 : entity is "top,Vivado 2022.2";
